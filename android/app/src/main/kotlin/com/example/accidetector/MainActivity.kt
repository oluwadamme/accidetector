...
class MainActivity: FlutterActivity() {
    private val methodChannelName: String = "com.example.accidetector.androidMethodChannel"
    private val eventChannelName: String = "com.example.accidetector.androidEventChannel"
    ...
    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        ...
        methodChannel = MethodChannel(flutterEngine.getDartExecutor(), methodChannelName)
        methodChannel.setMethodCallHandler { methodCall, result ->
            when(methodCall.method){
                "getSensorsList" -> {
                    eventChannel = EventChannel(flutterEngine.getDartExecutor(), eventChannelName)
